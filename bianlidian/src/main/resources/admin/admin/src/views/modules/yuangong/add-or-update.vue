            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='yuangongName'){
                          this.ruleForm.yuangongName = obj[o];
                          this.ro.yuangongName = true;
                          continue;
                      }
                      if(o=='yuangongPhone'){
                          this.ruleForm.yuangongPhone = obj[o];
                          this.ro.yuangongPhone = true;
                          continue;
                      }
                      if(o=='yuangongIdNumber'){
                          this.ruleForm.yuangongIdNumber = obj[o];
                          this.ro.yuangongIdNumber = true;
                          continue;
                      }
                      if(o=='yuangongPhoto'){
                          this.ruleForm.yuangongPhoto = obj[o];
                          this.ro.yuangongPhoto = true;
                          continue;
                      }
                      if(o=='sexTypes'){
                      ...
                      if(o=='yuangongEmail'){
                          this.ruleForm.yuangongEmail = obj[o];
                          this.ro.yuangongEmail = true;
                          continue;
                      }
                    }
                }
