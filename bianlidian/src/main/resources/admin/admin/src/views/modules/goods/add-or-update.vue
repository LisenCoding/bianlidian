    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="商品唯一编号" prop="goodsUuidNumber">
                       <el-input v-model="ruleForm.goodsUuidNumber"
                                 placeholder="商品唯一编号" clearable  :readonly="ro.goodsUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="进价" prop="goodsNewMoney">
                       <el-input v-model="ruleForm.goodsNewMoney"
                                 placeholder="进价" clearable  :readonly="ro.goodsNewMoney"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="进价" prop="goodsNewMoney">
                           <el-input v-model="ruleForm.goodsNewMoney"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="售价" prop="goodsXiaoshouMoney">
                       <el-input v-model="ruleForm.goodsXiaoshouMoney"
                                 placeholder="售价" clearable  :readonly="ro.goodsXiaoshouMoney"></el-input>
                   </el-form-item>
                   <div v-else>
    ...
    export default {
        data() {
            return {
                ...
                role : "",//权限
                ro:{
                    goodsUuidNumber: false,
                    goodsName: false,
                    goodsPhoto: false,
                    goodsTypes: false,
                    goodsKucunNumber: false,
                    goodsNewMoney: false,
                    goodsXiaoshouMoney: false,
                    shangxiaTypes: false,
                    goodsDelete: false,
                    goodsContent: false,
                },
                ruleForm: {
                    goodsUuidNumber: new Date().getTime(),
                    goodsName: '',
                    goodsPhoto: '',
                    goodsTypes: '',
                    goodsKucunNumber: '',
                ...
                rules: {
                   goodsUuidNumber: [
                              { required: true, message: '商品唯一编号不能为空', trigger: 'blur' },
                          ],
                   goodsName: [
        ...
        created() {
            ...
            if (this.role != "管理员"){
                ...
                this.ro.goodsXiaoshouMoney = true;
            }
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='goodsUuidNumber'){
                          this.ruleForm.goodsUuidNumber = obj[o];
                          this.ro.goodsUuidNumber = true;
                          continue;
                      }
                      if(o=='goodsName'){
                      ...
                      if(o=='goodsXiaoshouMoney'){
                          this.ruleForm.goodsXiaoshouMoney = obj[o];
                          this.ro.goodsXiaoshouMoney = true;
                          continue;
                      }
                      if(o=='shangxiaTypes'){
