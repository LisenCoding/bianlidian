    ...
    */
    ...
    public R save(@RequestBody GongyingshangEntity gongyingshang, HttpServletRequest request){
        ...
        Wrapper<GongyingshangEntity> queryWrapper = new EntityWrapper<GongyingshangEntity>()
            ...
            .eq("gongyingshang_lianxi_name", gongyingshang.getGongyingshangLianxiName())
            .eq("gongyingshang_phone", gongyingshang.getGongyingshangPhone())
            .eq("gongyingshang_types", gongyingshang.getGongyingshangTypes())
            .eq("gongyingshang_suozaidiqu_types", gongyingshang.getGongyingshangSuozaidiquTypes())
...
//                            gongyingshangEntity.setGongyingshangLianxiName(data.get(0));                    //供应商联系人 要改的
//                            gongyingshangEntity.setGongyingshangPhone(data.get(0));                    //供应商联系人手机号 要改的
//                            gongyingshangEntity.setGongyingshangTypes(Integer.valueOf(data.get(0)));   //供应商类型 要改的
//                            gongyingshangEntity.setGongyingshangSuozaidiquTypes(Integer.valueOf(data.get(0)));   //所在地区 要改的
...
//                            gongyingshangEntity.setCreateTime(date);//时间
                        ...
                        if(gongyingshangEntities_gongyingshangPhone.size() >0 ){
                            ...
                            return R.error(511,"数据库的该表中的 [供应商联系人手机号] 字段已经存在 存在数据为:"+repeatFields.toString());
                        }
